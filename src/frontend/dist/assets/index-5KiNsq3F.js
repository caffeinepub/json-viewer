...
const FileJson = createLucideIcon("file-json", __iconNode$6);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const GitCompare = createLucideIcon("git-compare", __iconNode$5);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
function walk(aVal, bVal, path, pathMap, counts) {
  const aUndef = aVal === void 0;
  const bUndef = bVal === void 0;
  if (aUndef && !bUndef) {
  ...
  if (aIsObj && bIsObj) {
    const ao = a;
    const bo = b;
    const allKeys = /* @__PURE__ */ new Set([...Object.keys(ao), ...Object.keys(bo)]);
...
function computeDiff(jsonA, jsonB) {
...
function getDiffStatus(pathMap, path) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full min-h-0", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-4 py-3 border-b border-border shrink-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono font-semibold tracking-widest text-muted-foreground uppercase", children: label }),
        value && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
          {
            className: `text-[10px] font-mono px-1.5 py-0.5 rounded ${isValid ? "bg-green-500/15 text-green-600 dark:text-green-400" : "bg-destructive/15 text-destructive"}`,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(FileJson, { size: 12 }),
              "Sample"
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
          {
            ...
            className: "h-7 text-xs gap-1.5 font-mono",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(AlignLeft, { size: 12 }),
              "Format"
            ]
          }
        ),
    ...
    error && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { size: 14, className: "text-destructive mt-0.5 shrink-0" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono text-destructive leading-relaxed break-all", children: error })
        ]
      }
    )
  ] });
...
function DiffBadge({ status }) {
  const cls = {
    added: "bg-green-500/20 text-green-700 dark:text-green-400 border border-green-500/30",
    removed: "bg-red-500/20 text-red-700 dark:text-red-400 border border-red-500/30",
    changed: "bg-yellow-500/20 text-yellow-700 dark:text-yellow-400 border border-yellow-500/30",
    unchanged: "hidden"
  };
  const label = {
    added: "+added",
...
function CopyButton({
  ...
  const handleCopy = reactExports.useCallback(
    (e) => {
      e.stopPropagation();
      const text = typeof value === "string" ? value : typeof value === "number" || typeof value === "boolean" ? String(value) : value === null ? "null" : JSON.stringify(value, null, 2);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "button",
    {
      ...
      children: copied ? /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { size: 12, className: "text-green-500 dark:text-green-400" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Copy, { size: 12 })
    }
  );
}
function LeafNode({
  ...
  const rowHighlight = diffStatus === "added" ? "bg-green-500/8 hover:bg-green-500/12" : diffStatus === "removed" ? "bg-red-500/8 hover:bg-red-500/12" : diffStatus === "changed" ? "bg-yellow-500/8 hover:bg-yellow-500/12" : "hover:bg-muted/60";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "min-w-0 flex items-baseline gap-1.5 flex-1", children: [
          nodeKey !== null && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-sm text-foreground/80 shrink-0", children: nodeKey }),
          nodeKey !== null && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground text-sm shrink-0", children: ":" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
              className: `font-mono text-sm truncate ${colorClass[type] ?? ""}`,
              children: getValuePreview(value)
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(TypeBadge, { type }),
        diffStatus && diffStatus !== "unchanged" && /* @__PURE__ */ jsxRuntimeExports.jsx(DiffBadge, { status: diffStatus }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CopyButton, { value, className: "opacity-0 group-hover:opacity-100" })
      ]
    }
  );
}
function JsonTreeNode({
  ...
  const type = getValueType(value);
  const diffStatus = diffPathMap && path ? getDiffStatus(diffPathMap, path) : null;
  ...
  const countLabel = type === "array" ? `[${entries.length}]` : `{${entries.length}}`;
  const rowHighlight = diffStatus === "added" ? "bg-green-500/8 hover:bg-green-500/12" : diffStatus === "removed" ? "bg-red-500/8 hover:bg-red-500/12" : diffStatus === "changed" ? "bg-yellow-500/8 hover:bg-yellow-500/12" : "hover:bg-muted/60";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground shrink-0", children: expanded ? /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { size: 14 }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { size: 14 }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "min-w-0 flex items-baseline gap-1.5 flex-1", children: [
            nodeKey !== null && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-sm text-foreground/80 shrink-0", children: nodeKey }),
            nodeKey !== null && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground text-sm shrink-0", children: ":" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-sm text-muted-foreground", children: countLabel })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TypeBadge, { type }),
          diffStatus && diffStatus !== "unchanged" && /* @__PURE__ */ jsxRuntimeExports.jsx(DiffBadge, { status: diffStatus }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    expanded && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: entries.map(([k, v]) => {
      const childPath = path ? type === "array" ? `${path}[${k}]` : `${path}.${k}` : k;
      return /* @__PURE__ */ jsxRuntimeExports.jsx(
        JsonTreeNode,
        {
          nodeKey: k,
...
function filterJson(value, query) {
...
function JsonTreePanel({
  ...
  const displayJson = reactExports.useMemo(() => {
    if (!parsedJson) return null;
    if (!search.trim()) return parsedJson;
    return filterJson(parsedJson, search.trim());
  }, [parsedJson, search]);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full min-h-0", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-4 py-3 border-b border-border shrink-0 gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono font-semibold tracking-widest text-muted-foreground uppercase shrink-0", children: label }),
      parsedJson !== null && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex-1 max-w-xs", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Search,
          {
            size: 12,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: parsedJson === null ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center h-full gap-3 px-8 text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-xl bg-muted flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(TreePine, { size: 22, className: "text-muted-foreground" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-foreground/70", children: "No JSON loaded" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1", children: "Paste valid JSON in the input panel to see the tree view" })
          ] })
        ] }) : displayJson === null ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col items-center justify-center h-full gap-2 px-8 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-muted-foreground", children: [
          "No keys match “",
          search,
          "”"
        ] }) }) : /* @__PURE__ */ jsxRuntimeExports.jsx(
  ...
  if (total === 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono text-accent-foreground font-semibold", children: "✓ Identical — no differences found" })
      }
    );
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      "data-ocid": "diff-summary",
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] font-mono font-semibold text-muted-foreground uppercase tracking-widest", children: "Diff" }),
        diff.added > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1 text-xs font-mono", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block w-2 h-2 rounded-full bg-green-500" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-green-700 dark:text-green-400 font-semibold", children: [
            "+",
            diff.added
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: "added" })
        ] }),
        diff.removed > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1 text-xs font-mono", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block w-2 h-2 rounded-full bg-red-500" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-red-700 dark:text-red-400 font-semibold", children: [
            "-",
            diff.removed
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: "removed" })
        ] }),
        diff.changed > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1 text-xs font-mono", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block w-2 h-2 rounded-full bg-yellow-500" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-yellow-700 dark:text-yellow-400 font-semibold", children: [
            "~",
            diff.changed
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: "changed" })
        ] })
      ]
    }
  );
...
function ComparePanel({
  ...
  const [inputA, setInputA] = reactExports.useState("");
  const [inputB, setInputB] = reactExports.useState("");
  const [parsedA, setParsedA] = reactExports.useState(null);
  const [parsedB, setParsedB] = reactExports.useState(null);
  ...
  reactExports.useEffect(() => {
    const { value, error } = parseJson$1(inputA);
    setParsedA(value);
    setErrorA(error);
  }, [inputA]);
  reactExports.useEffect(() => {
    const { value, error } = parseJson$1(inputB);
    setParsedB(value);
    setErrorB(error);
  }, [inputB]);
  const diff = reactExports.useMemo(() => computeDiff(parsedA, parsedB), [parsedA, parsedB]);
  const hasBothJson = parsedA !== null && parsedB !== null;
  const handleFormatA = reactExports.useCallback(() => {
    const { value, error } = parseJson$1(inputA);
    if (!error && value !== null) setInputA(JSON.stringify(value, null, 2));
  }, [inputA]);
  const handleFormatB = reactExports.useCallback(() => {
    const { value, error } = parseJson$1(inputB);
    if (!error && value !== null) setInputB(JSON.stringify(value, null, 2));
  }, [inputB]);
  const handleLoadSampleA = reactExports.useCallback(() => setInputA(SAMPLE_A), []);
  const handleLoadSampleB = reactExports.useCallback(() => setInputB(SAMPLE_B), []);
  const handleClearA = reactExports.useCallback(() => {
    setInputA("");
    setParsedA(null);
    setErrorA(null);
  }, []);
  const handleClearB = reactExports.useCallback(() => {
    setInputB("");
    setParsedB(null);
    setErrorB(null);
  }, []);
  const handleShareCompare = reactExports.useCallback(() => {
    onShare == null ? void 0 : onShare({ inputA, inputB });
  }, [onShare, inputA, inputB]);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full min-h-0", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center shrink-0 border-b border-border bg-muted/40", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 min-w-0", children: hasBothJson && /* @__PURE__ */ jsxRuntimeExports.jsx(DiffSummary, { diff }) }),
      onShare && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-3 py-2 shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          type: "button",
          ...
          className: `flex items-center gap-1.5 px-3 py-1.5 rounded-md text-xs font-mono font-semibold border transition-smooth ${shareStatus === "copied" ? "bg-accent/20 border-accent/40 text-accent-foreground cursor-default" : "bg-card border-border text-muted-foreground hover:text-foreground hover:border-primary/50"}`,
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { size: 13 }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: shareStatus === "copied" ? "Copied!" : "Share" })
          ]
        }
      ) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col lg:flex-row min-h-0 overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col w-full lg:w-1/2 lg:border-r border-border min-h-0 h-[50%] lg:h-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-[45vh] lg:h-[45%] border-b border-border shrink-0 flex flex-col", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          JsonInputPanel,
          {
            value: inputA,
            onChange: setInputA,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 min-h-0 bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          JsonTreePanel,
          {
            parsedJson: parsedA,
            label: "Tree A",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col w-full lg:w-1/2 min-h-0 h-[50%] lg:h-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-[45vh] lg:h-[45%] border-b border-border shrink-0 flex flex-col bg-card", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          JsonInputPanel,
          {
            value: inputB,
            onChange: setInputB,
...
function JsonViewerPage() {
  const [mode, setMode] = reactExports.useState("single");
  const [input, setInput] = reactExports.useState("");
  const [parsedJson, setParsedJson] = reactExports.useState(null);
  const [parseError, setParseError] = reactExports.useState(null);
  const [shareStatus, setShareStatus] = reactExports.useState("idle");
  const [manualUrl, setManualUrl] = reactExports.useState("");
  const [compareInputs, setCompareInputs] = reactExports.useState(null);
  const manualInputRef = reactExports.useRef(null);
  const shareTimerRef = reactExports.useRef(null);
  reactExports.useEffect(() => {
  ...
  const handleLoadSample = reactExports.useCallback(() => {
    ...
    (opts) => {
      ...
      if (mode === "single") {
        ...
        url = encodeShareState({
          mode: "compare",
          a: (opts == null ? void 0 : opts.inputA) ?? "",
          b: (opts == null ? void 0 : opts.inputB) ?? ""
        });
      }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-screen bg-background overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "bg-card border-b border-border shrink-0 px-5 py-3 flex items-center justify-between gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5 min-w-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-7 h-7 rounded-md bg-primary flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Braces, { size: 15, className: "text-primary-foreground" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-baseline gap-2 min-w-0", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:inline-block text-xs text-muted-foreground font-body truncate", children: "Interactive JSON viewer & formatter" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 shrink-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "fieldset",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("legend", { className: "sr-only", children: "View mode" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  type: "button",
                  ...
                  className: `flex items-center gap-1.5 px-3 py-1.5 rounded-md text-xs font-mono font-semibold transition-smooth ${mode === "single" ? "bg-card text-foreground shadow-sm" : "text-muted-foreground hover:text-foreground"}`,
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(ScanSearch, { size: 13 }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:inline", children: "Single" })
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  className: `flex items-center gap-1.5 px-3 py-1.5 rounded-md text-xs font-mono font-semibold transition-smooth ${mode === "compare" ? "bg-card text-foreground shadow-sm" : "text-muted-foreground hover:text-foreground"}`,
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(GitCompare, { size: 13 }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:inline", children: "Compare" })
                  ]
                }
              )
            ]
        ...
        mode === "single" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            type: "button",
            onClick: () => handleShare(),
    ...
    shareStatus === "manual" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-muted/60 border-b border-border px-5 py-2 flex items-center gap-2 shrink-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground font-mono shrink-0", children: "Copy link:" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "input",
        {
          ref: manualInputRef,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1 flex flex-col min-h-0 overflow-hidden", children: mode === "single" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col md:flex-row min-h-0 overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "flex flex-col w-full md:w-[40%] md:border-r border-b md:border-b-0 border-border bg-card min-h-0 h-[45vh] md:h-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        JsonInputPanel,
        {
          value: input,
          onChange: setInput,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "flex flex-col flex-1 bg-background min-h-0 h-[55vh] md:h-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx(JsonTreePanel, { parsedJson }) })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-card border-t border-border px-5 py-2 shrink-0 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[11px] text-muted-foreground", children: [
      "© ",
      (/* @__PURE__ */ new Date()).getFullYear(),
      ". Built with love by",
      " ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary font-medium", children: "@hongfy" })
    ] }) })
  ] });
}
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(JsonViewerPage, {});
}
